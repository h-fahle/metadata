...
/*         isFolder = false, selectMultiple = false
        // 2. Einzelnes Bild
        stapelmodus = 0;    // ein Bild

        isFolder = false, selectMultiple = true
        // mglw. mehrere Dateien
        if (auswahl.length === 1) stapelmodus = 0;

        isFolder = true, selectMultiple = false
        // Ordner
 ...
 */
        ...
        if (auswahl.length === 1) {
            ...
            stapelmodus = 1;    // mehrere ausgewählte Bilder
            bilderListe = auswahl;
