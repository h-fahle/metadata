 ...
 async function ladeOrdnerBilder(pfad) {
    try {
        bilderListe = await invoke('hole_ordner_bilder', { 
            ...
            nutzeParent: true  // durchsuche den übergeordneten ordner 
        });
    ...
    try {
        ...
        if (stapelmodus === 0) {
            ...
            bilderListe = await invoke('hole_ordner_bilder', {
                dateipfad: startBild,
                gueltigeEndungen: bildTypen,
                nutzeParent: false  // durchsuche exakt diesen ordner
             });
        ...
        if (stapelmodus > 0) {
            ...
            // Holt das Bild relativ zur aktuellen HTML-Seite über den echten Dev-Server
            ...
            console.log("Erfolgreiche URL:", vorschauImg.src);
